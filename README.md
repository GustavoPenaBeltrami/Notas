...
2. `/slp-session`: start every study session here. It tells you what's pending
...
│   └── agents/  # researcher, teacher-<slug>
├── app/         # local notebook and exam simulator
└── topics/      # your study, as Markdown and JSON. No database
```

- **core**: the app, your notes, exams and review. Needs no model at all
- **agent layer**: skills that teach, build exams, grade and review, on whatever model you plug in
...
| [`/slp-session`](https://selflearningplatform.github.io/docs/slp-session) | plan | What's pending today, and what to do |
| [`/slp-summarize`](https://selflearningplatform.github.io/docs/slp-summarize) | prepare | Summarizes material into the topic's notes |
| [`/slp-teach`](https://selflearningplatform.github.io/docs/slp-teach) | prepare | Teaches until it's understood, not memorized |
...
| [`/slp-review`](https://selflearningplatform.github.io/docs/slp-review) | review | Spaced, interleaved Leitner review |
...
- **[notes](https://selflearningplatform.github.io/docs/editor)**: a notebook per topic, saved as Markdown as you type. Mermaid, LaTeX and images
...
- **[dictation](https://selflearningplatform.github.io/docs/dictation)**: speak your notes or oral answers. Runs locally with Whisper
- **[settings](https://selflearningplatform.github.io/docs/settings)**: profile, themes, fonts. Plus slash commands and keyboard [shortcuts](https://selflearningplatform.github.io/docs/shortcuts)
...
Review cards in the app, session log, a per-topic knowledge base, more agents tested. See the [roadmap](https://selflearningplatform.github.io/docs/roadmap).
